...
import { Stethoscope, IndianRupee, Plus } from "lucide-react";
...
export function DoctorsList({ tenant }: DoctorsListProps) {
  ...
  const {
    ...
    defaultValues: { type: "doctor", targetAmount: 0 },
  });
    ...
    <>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Add Reference Person</DialogTitle>
          </DialogHeader>
          <form
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Expected monthly business from this reference. Shown in Reports.
              </p>
            </div>
